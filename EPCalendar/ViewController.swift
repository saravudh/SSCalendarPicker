...
class ViewController: UIViewController, EPCalendarPickerDelegate {
    ...
    @IBAction func onTouchShowMeCalendarButton(_ sender: AnyObject) {
        ...
        let date3 = Date(year: 2017, month: 5, day: 12)
        let calendarPicker = EPCalendarPicker(startYear: 2016, endYear: 2017, selectionType: .multiple, selectedDates: [date1, date2, date3])
